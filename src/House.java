...
public class House {
    ...
    private int turn(Jiqiren jiqiren, String[][] ground, int times, int code) {
        if (times == 0) {
            return 1;
        }
        int count = 0;
...
//            count++;
            ...
            count += turn(jiqiren, ground, times - 1, 1);
...
//            count++;
            ...
            System.out.println(times + "!!![" + localX + "][" + localY + "] -------> [" + (localX - 1) + "][" + localY + "] >>>>>>{");
            count += turn(jiqiren, ground, times - 1, 2);
            System.out.println(times + "!!!}");
            jiqiren.right();
            ground[localX - 1][localY] = null;
        }
...
//            count++;
            ...
            count += turn(jiqiren, ground, times - 1, 3);
            System.out.println(times + "!!!}");
...
//            count++;
            ...
            System.out.println(times + "!!![" + localX + "][" + localY + "] -------> [" + localX + "][" + (localY - 1) + "] >>>>>>{");
            count += turn(jiqiren, ground, times - 1, 4);
            System.out.println(times + "!!!}");
    ...
    public static void main(String[] args) {
        ...
        count = house.turn(jiqiren, ground, TIMES, 0);
